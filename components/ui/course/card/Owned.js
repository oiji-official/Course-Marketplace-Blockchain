...
export default function OwnedCourseCard({children, course}) {
  ...
  return (
    <div className="bg-white border shadow overflow-hidden sm:rounded-lg mx-28 mb-11">
      <div className="flex">
        ...
        <div className="flex-4">
          <div className="px-4 py-5 sm:px-6">
            <h3 className="text-lg leading-6 font-medium text-gray-900">
              <span className="mr-2 py-1">{course.title}</span>
              <span className={`text-xs py-1 text-${stateColor}-700 bg-${stateColor}-200 rounded-full p-2`}>
                {course.state}
              </span>
            </h3>
